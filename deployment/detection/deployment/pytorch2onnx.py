...
# python pytorch2onnx.py detector_config/config.py detector_weight/latest.pth  --output-file output/sketch_detector.onnx --input-img data/test1.png --dynamic-export --cfg-options model.test_cfg.deploy_nms_pre=-1
...
def pytorch2onnx(model,
    ...
    if verify:
        ...
        if torch.cuda.is_available():
            ...
            img_list = [_.contiguous() for _ in img_list]
...
def pytorch2onnx_only_verify(model,
                             input_img,
                             input_shape,
                             normalize_cfg,
                             opset_version=11,
