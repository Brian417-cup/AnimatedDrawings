...
class Vectors():
    ...
    def __init__(self, vs_: Union[
        Iterable[Union[float, int, Vectors, npt.NDArray[np.float32]]], Vectors]) -> None:  # noqa: C901

        # [N,dim] it means it can have N groups of dim-th vectors
